...
@section('dashboard-content')
    <div class="container mt-4">
        <a href="/dashboard/izin/pulang/pending" class="mt-3 text-decoration-none"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
        <div class="row mb-md-0 mb-3 mt-3"> <!-- Add mb-3 for small screens and mb-md-0 for larger screens -->
            <div class="col-md-6">
                <h5 class="mb-4">Detail Izin</h5>
            </div>
        ...
        <div class="row">
            <div class="container">
                    @include('izin.layout.table-izin')
            </div>
        </div>
    </div>
