@extends('izin.terlambat')

@section('izin-content')
    <div class="row mb-3">
        <div class="col-md-6">
    ...
    <div class="row">
        <h6 class="text-center">Data izin terlambat yang pending</h6>
            ...
            <table id="data-table" class="table table-striped" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="aksi">
                            <a href="/dashboard/izin/pulang/pending/detail" class="btn btn-primary btn-sm"><i
    ...
    <script>
        ...
        function addCuti() {
            ...
            // Update modal title
            $('#CutiModalLabel').text('Tambah Daftar Cuti');

            // Set form action for adding a new Cuti
            $('#CutiForm').attr('action', '/cuti/store');
