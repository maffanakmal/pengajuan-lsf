...
@section('dashboard-content')
    <div class="container mt-4">
        <div class="row mb-3">
            <div class="col-md-6">
                <h5 class="mb-4">Daftar Keluarga</h5>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="keluargaModalLabel">Tambah Daftar Keluarga</h1>
                ...
                <div class="modal-body">
                    ...
                    <form id="keluargaForm" action="/store" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="nama_keluarga" placeholder="Nama Keluarga"
