...
@section('dashboard-content')
                ...
                <table id="data-table" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Kesehatan</td>
                            <td>Affan</td>
                            <td>Gedung F Komplek Kemendikbud RI</td>
                            <td class="aksi">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="unitKerjaForm" action="/store" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="Lokasi" id="lokasi" name="lokasi"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="UnitkerjaForm" class="btn btn-primary btn-sm"
    ...
    <script>
        // Function to handle "Add Unitkerja" button
        ...
        // Function to handle "Edit Unitkerja" button
