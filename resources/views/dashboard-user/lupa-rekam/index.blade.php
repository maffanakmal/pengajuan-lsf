...
@section('user-content')
    <div class="container mt-4">
        <div class="row d-flex justify-content-between align-items-center mb-3">
            <div class="col-6">
                <h6>Permohonan Lupa Rekam Kehadiran</h6>
            </div>
            <div class="col-6 text-end">
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#PengajuanIzin">Buat Permohonan</button>
            </div>
        </div>
            ...
            <div class="col-sm-4 col-lg-4 mb-2">
                <div class="card">
                    <div class="card-body d-flex justify-content-between">
                        <div class="card-info">
                            <div class="cuti-info">
                                <h6 class="mb-0">Lupa Rekam Kehadiran Pulang</h6>
                                <small class="mb-0">20 Juni 2024</small>
                            </div>
                            <a href="{{ route('user.lupa-rekam.detail') }}" class="btn btn-primary btn-sm mt-2">Detail</a>
                        </div>
