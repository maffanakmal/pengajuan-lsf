...
<div class="container mt-4">
    <div class="row d-flex justify-content-between align-items-center mt-2">
        <div class="col-6">
            <a href="{{ route('user.lupa-rekam.index') }}" class="text-decoration-none"><i class="fa-solid fa-chevron-left"></i> Kembali</a>
        </div>
        <div class="col-6 text-end">
            <a href="" class="btn btn-success btn-sm">Cetak PDF</a>
    </div>
    <div class="row mt-2">
        <h6 class="text-center mb-2">Detail Permohonan</h6>
